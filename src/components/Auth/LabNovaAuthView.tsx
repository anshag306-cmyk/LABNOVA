            ...
            <div className="pt-2 border-t border-slate-800/80 space-y-2.5">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">
                  ⚡ 1-Click Verification Accounts
                </span>
                <span className="text-[10px] text-blue-400 font-mono">Instant Login</span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                ...
                <button
                  ...
                  className="p-2.5 rounded-xl bg-slate-800/60 hover:bg-purple-900/30 border border-slate-700/80 hover:border-purple-500/50 text-left transition-all group"
                >
                  <div className="flex items-center justify-between">
